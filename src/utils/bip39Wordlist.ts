export const BIP39_ENGLISH_WORDLIST: string[] = [
  ...
  "caught", "cause", "caution", "cave", "ceiling", "celery", "cement", "census", "cereal", "certain",
  ...
  "clown", "club", "clump", "cluster", "clutch", "coach", "coal", "coast", "coconut", "code",
  ...
  "debris", "decade", "december", "decide", "decline", "decor", "decrease", "deer", "defense", "define",
  ...
  "meadow", "mean", "measure", "meat", "mechanic", "medal", "media", "melody", "melon", "melt",
  ...
  "outside", "oval", "oven", "over", "own", "owner", "oxygen", "oyster", "ozone", "pack",
  "packet", "paddle", "page", "pair", "palace", "palm", "panda", "panel", "panic", "panther",
  ...
  "puma", "punch", "pupil", "puppy", "purchase", "purity", "purpose", "purse", "push", "put",
  ...
  "side", "sieges", "sight", "sign", "silent", "silk", "silly", "silver", "similar", "simple",
  ...
  "umbrella", "unable", "unaware", "uncle", "uncover", "under", "undo", "unfair", "unfold", "happy",
